...
> 当前生产 API：`0.20.1-20260727T145451Z`
...
| 类型 | 版本示例 | 必须验证 |
| --- | --- | --- |
| 启动器 | `launcher-v0.11.14` | 完整测试、安装/升级/卸载、登录、启动检查开关、下载、修复、诊断上传、隐私受限遥测、启动前授权 |
| API | `api-v0.20.1` | 数据库与论坛一致性备份、独立端口端到端验收、原子部署、健康/就绪、认证、敏感 URL 日志、旧域名与公网端口 |
...
`0.11.14` 首轮 2 至 3 人测试按
[`PRELAUNCH_PILOT_0.11.14.md`](PRELAUNCH_PILOT_0.11.14.md) 执行。该手册的“可以开始”
