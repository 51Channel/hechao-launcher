...
| 类型 | 版本示例 | 必须验证 |
| --- | --- | --- |
| 启动器 | `launcher-v0.11.15` | 完整测试、安装/升级/卸载、登录、日志配置恢复、下载、修复、诊断上传、隐私受限遥测、启动前授权 |
...
`0.11.15` 首轮 2 至 3 人测试按
[`PRELAUNCH_PILOT_0.11.15.md`](PRELAUNCH_PILOT_0.11.15.md) 执行。该手册的“可以开始”
