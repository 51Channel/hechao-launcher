...
> 当前生产 API：`0.14.1-20260726T190856Z`
> 当前启动器源码候选：`0.11.12`（私有 OSS 灰度版为 `0.11.11`）
...
| 类型 | 版本示例 | 必须验证 |
| --- | --- | --- |
| 启动器 | `launcher-v0.11.11` | 完整测试、安装/升级/卸载、登录、下载、修复、启动前授权 |
| API | `api-v0.14.1` | 数据库备份、独立端口启动预检、原子部署、健康/就绪、认证、旧域名与公网端口 |
...
`0.11.7` 首轮 2 至 3 人测试按
[`PRELAUNCH_PILOT_0.11.7.md`](PRELAUNCH_PILOT_0.11.7.md) 执行。该手册的“可以开始”
