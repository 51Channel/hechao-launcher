...
> 当前生产：API `0.32.0`、Publisher Agent `1.2.1`、owl5
...
> `0.32.0 / 0.7.0 / 0.5.0` 已将动态槽升级为独立端口和独立 Velocity 目标；工业季
> 已作为停止的独立生存槽完成迁移。本能力不会自动启动 Minecraft，也不会改变
> Gray/Production。正式证据见对应组件发布记录。
