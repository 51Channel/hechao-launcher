...
> 最近记录的线上版本：`0.30.4-20260814T093000Z`
> 最近记录的生产迁移：`028`
> 当前新增能力：活动企划、单活动排期、官网内部桥接、精确部署身份、LuckPerms 代理
> 版本/协议门禁与 Publisher 工作空间日志保护
