...
> 源码版本：API `0.20.2`（基础目录自 `0.7.0` 起保持兼容）
> 生产状态：API `0.20.2-20260727T225819Z` 已部署；真实管理员 MFA 已登记，发布写入尚未完成真实管理员页面验收
...
1. 生成并校验目标 API Linux 发布物、提交号与 SHA-256；当前生产为 `0.20.2-20260727T225819Z`。
...
当前生产故障时直接回滚目标为 API `0.20.1-20260727T145451Z`。
