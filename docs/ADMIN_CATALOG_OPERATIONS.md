...
> 源码版本：API `0.13.0`（本功能自 `0.7.0` 起保持兼容）
> 生产状态：API `0.13.0` 已部署，管理员 Web 已启用；当前 MFA 凭据数为 0，目录写入尚未完成真实管理员验收
...
1. 生成并校验目标 API Linux 发布物、提交号与 SHA-256；当前生产基线为 `0.13.0-20260726T173536Z`。
