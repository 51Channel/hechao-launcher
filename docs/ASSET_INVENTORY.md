...
- 启动器当前正式版本为 `0.15.4`，制品源码提交为
  `163e7506b14060da1ed340145ac188da6f698e30`，正式标签为
  `launcher-v0.15.4`。单文件 EXE 为 `69,016,318` 字节，SHA-256 为
  `96C45B1F7BFDBB04CA360F45CDE0D84EC787FD3F4E271FA9F3397F0B314F4ECC`；
  NSIS 为 `61,965,169` 字节，SHA-256 为
  `42D60ED9149D4ED03A9B0958482DEF9FE004C212CE95BA39912E366A665194B5`。
  两者均为 `NotSigned`。完整解决方案 `710/710`，启动器 `225/225`。
- `0.15.4` 私有 OSS 对象匿名读取 `403`、两轮签名回读 `200`，长度与
  SHA-256 一致；`0.15.3 -> 0.15.4` 覆盖安装、全新安装、双轮卸载、设置和
  DPAPI 会话保留已验收。`0.15.3` 保留为上一正式版本，其不可变对象与标签不得覆盖。
- 生产更新通道当前为 `LatestVersion=0.15.4`、
