...
- 启动器当前正式版本为 `0.15.8`，制品源码提交为
  `30c438bb4e6e7ea6ba8f5c2b8afc9dff2d8cf85f`，正式标签为
  `launcher-v0.15.8`。单文件 EXE 为 `69,029,855` 字节，SHA-256 为
  `276A10753EAE317AE809B4A264A45B8974C9344D1A2657FA68277669CAFE2B53`；
  NSIS 为 `61,974,181` 字节，SHA-256 为
  `737DC71A63D7B3B1F0E4E7967162183C1BDED1C232E771855ED28DA626FA3BA1`。
  两者均为 `NotSigned`。完整解决方案 `748/748`，启动器 `229/229`。
- `0.15.8` 私有 OSS 对象匿名读取 `403`、两轮签名回读 `200`，长度与
