...
- 启动器当前正式版本为 `0.15.3`，制品源码提交为
  `012cdd3c739d98fce5bee2326f8ec9813931f94b`，正式标签为
  `launcher-v0.15.3`。单文件 EXE 为 `69,016,860` 字节，SHA-256 为
  `8EE9A773A32F509A6FAD3CF63FF2D8D4046BA4FA94207F9190862888CDD1AE37`；
  NSIS 为 `61,954,842` 字节，SHA-256 为
  `EC84277585366D8C1FF1B1AB60E89AA433BF142BDC26B924E772D88F52A271CE`。
  两者均为 `NotSigned`。完整解决方案 `710/710`，启动器 `225/225`。
- `0.15.3` 私有 OSS 对象匿名读取 `403`、两轮签名回读 `200`，长度与
  SHA-256 一致；`0.15.2 -> 0.15.3` 覆盖安装、全新安装、双轮卸载、设置和
  DPAPI 会话保留已验收。`0.15.2` 保留为上一正式版本，其不可变对象与标签不得覆盖。
- 生产更新通道当前为 `LatestVersion=0.15.3`、
