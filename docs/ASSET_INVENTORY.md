...
- NeoForge 活动档案本地签名候选为 `activity-neoforge-1.21.11` / `1.0.10`，清单 SHA-256 为 `0E059BBFE9FAB6770204DE547567CA64420A45E8364FA93206BB316E8AE2B69F`；包含 `4,754` 个文件与对象、`621,732,083` 字节。线上未发布占位版本为 `1.0.9`，候选已顺延避免降级。Meccha SHA-256 `C72511BEF3B0CC2C1A1C97E1C33709901714460191F9549FD461E71215534E9E` 与活动服一致；生产信任验签、发布物闭合验收、全量安装、逐文件复验和 NeoForge `21.11.42` 进程构建均通过，当前解决方案测试为 `150/150`，尚未上传或启用。
