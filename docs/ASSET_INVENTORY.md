...
- 启动器当前正式版本为 `0.15.6`，制品源码提交为
  `181ce7cd6e73e1782b56c869873281645b599260`，正式标签为
  `launcher-v0.15.6`。单文件 EXE 为 `69,017,381` 字节，SHA-256 为
  `8D7670AFA2FEA6B6E781F2A7BE9A43AFC33980B9298249A47475B98802DDD6C1`；
  NSIS 为 `61,962,345` 字节，SHA-256 为
  `00C5C21CE8ABEA2FB15DA49DFB2CD5BA267E582DE49DBF96D91EF938C41822B3`。
  两者均为 `NotSigned`。完整解决方案 `710/710`，启动器 `225/225`。
- `0.15.6` 私有 OSS 对象匿名读取 `403`、两轮签名回读 `200`，长度与
  SHA-256 一致；`0.15.5 -> 0.15.6` 覆盖安装、全新安装、双轮卸载、设置和
  DPAPI 会话保留已验收。`0.15.5` 保留为上一正式版本，其不可变对象与标签不得覆盖。
- 生产更新通道当前为 `LatestVersion=0.15.6`、
