...
1. 玩家主手持有物品并执行 `/sell`。
2. 插件拒绝空气、容器、命名、附魔、带数据组件或其他复杂元数据物品；这些物品永久不走
   官方回收，后续只能进入玩家市场。
...
上述复杂物品不是禁止玩家交易。正式边界是：官方回收只按白名单标准物品铸币；带 NBT、
数据组件、内部内容或模组能力的物品由玩家自行定价，待完整物品托管与兼容组校验上线后
进入玩家市场。玩家市场成交只转移已有货币。当前版本尚未实现该市场，因此暂时只能当面
交换，不能通过系统挂单。
...
17 种物品的 Minecraft ID、单价、个人日限、全服日限和首发禁售边界已经拆成独立权威
文档：
