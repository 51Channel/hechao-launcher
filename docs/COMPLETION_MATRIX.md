...
| 经济行情与财富分布 | 已实现待生产部署 | 候选后台新增“经济监控”，提供 24 小时、7/30/90 天全局货币供给折线、新增货币、转账额、财富分布、玩家余额、物资回收和分服流量。迁移 032 只增加查询索引；本地 API `366/366`、Vitest `16/16`、Playwright `34/34` 和十二路由 WCAG A/AA 通过，隔离 PostgreSQL 集成测试等待有测试库的发布门执行 |
