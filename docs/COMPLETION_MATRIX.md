...
| 自动测试 | 已完成 | 当前分支完整解决方案 `815` 项通过、`1` 项隔离 PostgreSQL 条件测试跳过，其中 API `368/368`、Agent `76/76`、Launcher `234/234`、Distribution `47/47`；Vitest `19/19`、Playwright `34/34`、改动格式、PowerShell 7 和 `git diff --check` 通过 |
