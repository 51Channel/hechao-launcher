...
public sealed class ServerControlAdminPayloadContractTests
{
    ...
    public void Overview_ExcludesConsoleAndHistoricalOperations()
    {
        var overview = new AdminServerControlOverview(
            ...
            [new AdminServerControlTargetSummaryRecord(
                ...
                PackageDeploymentMemoryGuidance:
                    new ServerMemoryGuidance(32768, 4096, 16384))]);
        ...
        Assert.Contains(
            "\"packageDeploymentMemoryGuidance\":{\"hostTotalMemoryMiB\":32768,\"recommendedMinimumMemoryMiB\":4096,\"recommendedMaximumMemoryMiB\":16384}",
            json,
