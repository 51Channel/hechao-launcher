...
docs/examples/ACTIVITY_CHANNEL_MINIMAL_CASE.md。再进入实际源码仓库读取其 AGENTS.md、
Git 状态、构建文件和现有测试。
...
冲突组、世界备份和回滚目标。不要要求我重复交接包中已经写明且能够核验的信息。
...
接入。任何新物理后端必须加入 owl5-activity-slot、状态采集、指标、备份和告警。
```
