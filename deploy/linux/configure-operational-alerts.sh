...
HECHAO_MONITOR_PLATFORM_BACKUP_RECEIPT_PATH=/var/lib/hechao-offsite-platform-backup/latest.json
HECHAO_MONITOR_PLATFORM_BACKUP_FAILURE_PATH=/var/lib/hechao-offsite-platform-backup/failure.json
EOF
