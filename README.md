...
> `2026-09-04` 活动企划“先建活动、后加客户端”与真实承载服务器绑定已完成 API
> `0.38.4` 候选。管理员可以先保存未绑定客户端的草稿，随后选择整合包和负责运行它的
...
> 候选记录见
> [`docs/API_RELEASE_0.38.4_CANDIDATE.md`](docs/API_RELEASE_0.38.4_CANDIDATE.md)。
