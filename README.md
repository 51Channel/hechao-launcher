...
7. 启动器 `0.11.8` 完成制品发布后进入私有 OSS 的 2 至 3 人灰度；按对应版本小范围测试手册完成验收后再向玩家公开发布。
