...
> `2026-08-08` 主页三栏改版候选已完成：左侧宽导航、中间真实服务器目录、右侧当前
...
> 本次只提交候选源码，未发布安装包、未上传 OSS、未修改更新通道，也未操作任何服务端。
> 记录见 [`docs/LAUNCHER_HOME_REDESIGN_2026-08-08.md`](docs/LAUNCHER_HOME_REDESIGN_2026-08-08.md)。
