...
public final class MenuActions {
    ...
    private static Map<String, Definition> createActions() {
        ...
        actions.put(
                "balance",
                new Definition("我的余额", "查看当前金币余额", "hechaoeconomy:money", false));
        actions.put(
                "shop",
                new Definition("回收目录", "查看当前可出售物品", "hechaoeconomy:shop", false));
        actions.put(
                "sell",
                new Definition("出售主手", "为主手物品创建报价", "hechaoeconomy:sell", false));
        actions.put(
                "admin_product",
                new Definition(
                        "服主回收设置",
        ...
        actions.put(
                "settings",
                new Definition("个人设置", "打开生存服个人设置", "settings", false));
        actions.put(
                "team",
                new Definition("我的队伍", "打开队伍功能", "team", false));
