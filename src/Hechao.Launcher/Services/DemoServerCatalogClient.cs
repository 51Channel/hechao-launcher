...
public sealed class DemoServerCatalogClient : IServerCatalogClient
{
    public Task<LauncherCatalogSnapshot> GetCatalogAsync(CancellationToken cancellationToken = default)
    {
        ...
        [
            new("survival2", "天域生存", "域", "山", ServerStatus.Online, 18, 100, "1.21.11", ModLoaderKind.Paper, AccessTier.Member, "base-1.21.11", CatalogSection: ServerCatalogSection.Permanent),
            new("activity", "海绵小镇躲猫猫", "海", "海", ServerStatus.Online, 21, 30, "1.21.11", ModLoaderKind.NeoForge, AccessTier.Participant, "activity-neoforge-1.21.11", CatalogSection: ServerCatalogSection.Activity),
            new("dollnight", "玩偶惊魂夜", "偶", "偶", ServerStatus.Maintenance, 0, 30, "1.21.11", ModLoaderKind.Paper, AccessTier.Participant, "dollnight-1.21.11", CatalogSection: ServerCatalogSection.Activity)
        ];
